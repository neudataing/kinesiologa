...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-4 lg:py-6">
      {/* Contenedor principal con márgenes laterales aumentados */}
      <div className="container mx-auto max-w-7xl px-8 sm:px-10 lg:px-14">
        <div 
          ref={ref}
        ...
        >
          ...
          {/* Grid ajustado para acercar imagen y texto */}
